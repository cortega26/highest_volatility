...
| `HV_ANNOTATIONS_DB`          | `cache/annotations.db` | SQLite path for persisted annotation notes (legacy: `HV_ANNOTATIONS_DB_PATH`); environment placeholders are expanded and must resolve.
